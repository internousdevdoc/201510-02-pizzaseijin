	...
	<div id="usermod-window">
		<form>
			<table>
				...
				<tr>
					<td colspan="2"><a href="mypage.jsp"><input type="button" value="変更を登録する" /></a></td>
				</tr>
			</table>
		</form>
	</div>
	<div id="creditmod-window">
		<form>
			<table>
				...
				<tr>
					<td colspan="2"><a href="mypage.jsp"><input type="button" 
						value="変更を登録する" /></a></td>
				</tr>
			</table>
		</form>
	...
	<div class="container">
		...
		<hr>
			...
			<table class="sctable">
				...
				<tr>
					<td colspan="2"><a href="review.jsp"><input type="button" value="レビューを書く" /></a></td>
					<td colspan="2"><a href="review.jsp"><input type="button" value="レビューを書く" /></a></td>
					<td colspan="2"><a href="review.jsp"><input type="button" value="レビューを書く" /></a></td>
					<td colspan="2"><a href="review.jsp"><input type="button" value="レビューを書く" /></a></td>
					<td colspan="2"><a href="review.jsp"><input type="button" value="レビューを書く" /></a></td>
